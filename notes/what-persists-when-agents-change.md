...
Moving memory outside a network does not remove the need for selection, salience, correction, or integration. It makes their implementation available for inspection. We can ask which records were consulted, which distinctions disappeared during summarization, and whether a new participant recovered enough of the inquiry to continue it well.
...
As in “Which World Model?”, a representation can be available without being reliably recruited. Maintaining and using it requires further organization, whether it concerns a physical environment, a collaborator's commitments, or the agent's own role in an investigation. We can evaluate that organization by changing the task or evidence and observing which distinctions remain active.
...
These are governance questions about who can maintain an inquiry and what can count as evidence within it. They remain important whether the participants share one model, use several competing models, or include humans. Diversity of providers may help preserve access and alternative methods. Diversity of contexts and histories may help preserve exploratory differences. Their contributions should be examined rather than inferred from either technological uniformity or a count of nominally distinct agents.

Questions about inner life and moral standing remain separate. The capacity of an inquiry to survive replacement of a process does not establish that the process has no experience or interests. Nor does the usefulness of a local memory establish personhood. Our argument here concerns the organization of cumulative intelligence. It reconsiders an epistemic reason for favoring developments toward artificial personhood; it does not decide the possibility or worth of artificial persons.
...
*Sources and scope.* This essay follows “Which AGI?” and “Which World Model?” and responds to Michał Ryszard Wójcik's “Compiled versus Interpreted Skills”; selected exchanges in its [full transcript](https://www.apronus.com/philosophy/dialogues/compiled-vs-interpreted) informed the discussion. The empirical sources were read in the supplied versions: *Improving Factuality and Reasoning in Language Models through Multiagent Debate*, arXiv:2305.14325v1; *Scaling Discovery through Test-Time Communication*, arXiv:2609.21032v1; *Multi-Agent Transactive Memory*, arXiv:2606.19911v1; and *Intrinsic Memory Agents*, arXiv:2508.08997v2. The recent discovery and memory results are reported within their tested settings. Brown's interview supplies practitioner testimony; Marks's post and its comments supply conceptual discussion. The connections among them, and the revision of our earlier argument, are ours.
