...
My [2001 draft](https://lukstafi.github.io/projects/typed-gp/sources/MGP1.TXT) proposed ways of identifying corresponding parts and combining their differences. A [2002 continuation](https://lukstafi.github.io/projects/typed-gp/sources/GENERA.TXT) worked on generalization algorithms. By the time of my [2005 master's thesis](https://lukstafi.github.io/projects/typed-gp/sources/dyplom4.tm), written in Polish, the programme included substantial work on constructing terms in typed languages. The work combined a survey of existing approaches with new definitions, algorithms, proofs, and unfinished proposals. I ran out of time before experimenting with the intended system.
...
There is a later personal connection here. My [2015 PhD thesis, *GADTs for Reconstruction of Invariants and Postconditions*](https://lukstafi.github.io/projects/jca/lukstafi-phd-thesis.pdf), developed inference in the other direction: reconstructing informative types and contracts from programs. Generalization finds common consequences used in postconditions; abduction finds conditions supporting invariants. Anti-unification over free terms participates in that generalization. The resulting InvarGenT system was implemented, unlike the early evolutionary programme.
