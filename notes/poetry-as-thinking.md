...
*This article was co-authored by Łukasz Stafiniak and Claude (Anthropic). It draws on Jane Hirshfield's Ten Windows (2015) and Ledger (2020), Joe Carlsmith's "Fake Thinking and Real Thinking" (2025) and "On Attunement" (2024), and the philosophical framework developed across our series on mind, metaphysics, and artificial cognition. Previous articles in the series are available at [lukstafi.github.io](https://lukstafi.github.io/) and [Substack](https://lukstafi.substack.com/).*
