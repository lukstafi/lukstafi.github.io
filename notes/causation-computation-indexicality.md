...
*A Philosophical Framework in Four Layers*
...
### Layer 0: The Generative Principle

Efficient causation–computation. Not a thing in the world, but what makes there be a world of things. This is the primitive: it produces, it unfolds, it computes. It sits "beneath" the world of things not spatially or temporally, but ontologically. Everything that happens, happens because of this. It is constrained by the extended Church–Turing thesis, which on this view is not an empirical claim about the universe but a characterisation of what the primitive is.
...
Where things begin to be about other things. Intentionality, meaning, experience, models-of. The transition here is from information processing to representation — not merely carrying and transforming signals, but having content, modelling a world, perhaps being conscious. This is the layer of minds.
